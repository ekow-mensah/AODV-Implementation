...
; This file was generated Sat Jan 27 13:27:39 2018
;--------------------------------------------------------
	.module sensors
...
;------------------------------------------------------------
;prefix                    Allocated to stack - offset 1
;i                         Allocated to registers r7 r5 
...
;	../../../core/lib/sensors.c:125: if(sensors_flags[i] & FLAG_CHANGED) {
	...
	ljmp	00132$
00157$:
;	../../../core/lib/sensors.c:126: if(process_post(PROCESS_BROADCAST, sensors_event, sensors[i]) == PROCESS_ERR_OK) {
	push	ar2
	push	ar3
	push	ar4
	push	ar2
