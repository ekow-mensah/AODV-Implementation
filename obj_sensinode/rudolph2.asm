...
; This file was generated Sat Jan 27 13:25:35 2018
;--------------------------------------------------------
	.module rudolph2
...
;chunk                     Allocated to stack - offset -7
...
;------------------------------------------------------------
;chunk                     Allocated to stack - offset -4
;c                         Allocated to stack - offset 1
...
;------------------------------------------------------------
;chunk                     Allocated to stack - offset -4
;data                      Allocated to stack - offset -7
...
;c                         Allocated to stack - offset 1
;interval                  Allocated to stack - offset 4
;len                       Allocated to registers r4 r2 
...
;------------------------------------------------------------
;polite                    Allocated to stack - offset 1
...
;------------------------------------------------------------
;send_interval             Allocated to stack - offset -4
;c                         Allocated to stack - offset 1
