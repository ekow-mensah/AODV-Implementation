...
; This file was generated Sat Jan 27 13:27:12 2018
;--------------------------------------------------------
	.module uip_split
...
;------------------------------------------------------------
;tcplen                    Allocated to registers r2 r3 
;len1                      Allocated to stack - offset 1
;len2                      Allocated to stack - offset 3
;------------------------------------------------------------
...
;	../../../core/net/uip-split.c:110: BUF->len[1] = uip_len & 0xff;
	...
	mov	a,r2
	movx	@dptr,a
;	../../../core/net/uip-split.c:114: memcpy(uip_appdata, (u8_t *)uip_appdata + len1, len2);
