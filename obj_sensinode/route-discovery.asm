...
; This file was generated Sat Jan 27 13:25:19 2018
;--------------------------------------------------------
...
;dest_copy                 Allocated to stack - offset 4
;msg                       Allocated to stack - offset 6
...
;dest                      Allocated to stack - offset -5
;c                         Allocated to stack - offset 1
;rrepmsg                   Allocated to registers r5 r6 r7 
;rt                        Allocated to registers r2 r3 r4 
;saved_dest                Allocated to stack - offset 4
;------------------------------------------------------------
...
;------------------------------------------------------------
;last_hop                  Allocated to stack - offset -5
;hops                      Allocated to stack - offset -6
;originator                Allocated to registers r2 r3 r4 
;------------------------------------------------------------
...
;dest                      Allocated to stack - offset 7
;c                         Allocated to stack - offset 9
;originator                Allocated to stack - offset 12
;sloc0                     Allocated to stack - offset 14
;sloc1                     Allocated to stack - offset 18
...
;------------------------------------------------------------
;from                      Allocated to stack - offset -5
;originator                Allocated to stack - offset -8
;seqno                     Allocated to stack - offset -9
;hops                      Allocated to stack - offset -10
;nf                        Allocated to registers r2 r3 r4 
;msg                       Allocated to stack - offset 1
...
;channels                  Allocated to stack - offset -6
;callbacks                 Allocated to stack - offset -9
;c                         Allocated to stack - offset 1
;------------------------------------------------------------
...
;timeout                   Allocated to stack - offset -7
;c                         Allocated to registers r2 r3 r4 
;------------------------------------------------------------
