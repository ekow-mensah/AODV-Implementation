...
; This file was generated Sat Jan 27 13:27:08 2018
;--------------------------------------------------------
	.module psock
...
;------------------------------------------------------------
;	../../../core/net/psock.c:80: buf_bufdata(struct psock_buf *buf, u16_t len,
;	-----------------------------------------
...
;------------------------------------------------------------
;	../../../core/net/psock.c:108: buf_bufto(CC_REGISTER_ARG struct psock_buf *buf, u8_t endmarker,
;	-----------------------------------------
;	 function buf_bufto
;	-----------------------------------------
_buf_bufto:
...
;sloc4                     Allocated to stack - offset 6
;sloc5                     Allocated to stack - offset 8
;sloc6                     Allocated to stack - offset 11
;------------------------------------------------------------
...
;------------------------------------------------------------
;generate                  Allocated to stack - offset -4
;arg                       Allocated to stack - offset -7
;s                         Allocated to stack - offset 1
...
;------------------------------------------------------------
;psock                     Allocated to registers r2 r3 r4 
;------------------------------------------------------------
...
;psock                     Allocated to stack - offset 1
;PT_YIELD_FLAG             Allocated to registers 
;sloc0                     Allocated to stack - offset 4
;sloc1                     Allocated to stack - offset 6
;------------------------------------------------------------
...
;	../../../core/net/psock.c:274: psock->state = STATE_READ;
	...
	mov	a,#0x02
	lcall	__gptrput
;	../../../core/net/psock.c:275: psock->readptr = (u8_t *)uip_appdata;
	mov	r0,_bp
	inc	r0
	mov	a,#0x07
	add	a,@r0
...
;------------------------------------------------------------
;	../../../core/net/psock.c:289: PT_THREAD(psock_readbuf(CC_REGISTER_ARG struct psock *psock))
;	-----------------------------------------
...
;	../../../core/net/psock.c:293: buf_setup(&psock->buf, psock->bufptr, psock->bufsize);
	...
	pop	ar6
	pop	ar5
;	../../../core/net/psock.c:298: if(psock->readlen == 0) {
	mov	r0,_bp
	inc	r0
	mov	a,#0x0F
	add	a,@r0
	...
	ljmp	00109$
00125$:
;	../../../core/net/psock.c:299: PT_WAIT_UNTIL(&psock->psockpt, psock_newdata(psock));
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	mov	a,#0x2B
...
00102$:
	...
	ljmp	00116$
00106$:
;	../../../core/net/psock.c:300: psock->state = STATE_READ;
	mov	r0,_bp
	inc	r0
	mov	a,#0x18
	add	a,@r0
	...
	mov	a,#0x02
	lcall	__gptrput
;	../../../core/net/psock.c:301: psock->readptr = (u8_t *)uip_appdata;
	mov	r0,_bp
	inc	r0
	mov	a,#0x07
	add	a,@r0
	...
	mov	a,r7
	lcall	__gptrput
;	../../../core/net/psock.c:302: psock->readlen = uip_datalen();
	mov	r0,_bp
	inc	r0
	mov	a,#0x0F
	add	a,@r0
	...
	lcall	__gptrput
00109$:
;	../../../core/net/psock.c:306: &psock->readlen);
	mov	r0,_bp
	inc	r0
	mov	a,#0x0F
	add	a,@r0
	...
	inc	r0
	mov	ar4,@r0
;	../../../core/net/psock.c:305: &psock->readptr,
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0x04
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/net/psock.c:304: buf_bufdata(&psock->buf, psock->bufsize,
	mov	r0,_bp
	inc	r0
	mov	a,#0x16
	add	a,@r0
	...
	add	a,#0xf8
	mov	sp,a
;	../../../core/net/psock.c:308: if(psock_datalen(psock) == 0) {
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
	...
	orl	a,b
	jnz	00115$
;	../../../core/net/psock.c:309: psock->state = STATE_NONE;
	mov	r0,_bp
	inc	r0
	mov	a,#0x18
	add	a,@r0
	...
	clr	a
	lcall	__gptrput
;	../../../core/net/psock.c:310: PT_RESTART(&psock->psockpt);
	mov	r0,_bp
	inc	r0
	mov	a,#0x02
	add	a,@r0
	...
	lcall	__gptrput
	mov	dpl,#0x00
;	../../../core/net/psock.c:312: PT_END(&psock->psockpt);
	sjmp	00116$
00115$:
	mov	r0,_bp
	inc	r0
...
;buffersize                Allocated to stack - offset -7
;psock                     Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/psock.c:316: psock_init(CC_REGISTER_ARG struct psock *psock,
;	-----------------------------------------
;	 function psock_init
;	-----------------------------------------
_psock_init:
	...
	mov	r3,dph
	mov	r4,b
;	../../../core/net/psock.c:319: psock->state = STATE_NONE;
	mov	a,#0x18
	add	a,r2
	mov	r5,a
	clr	a
	...
	clr	a
	lcall	__gptrput
;	../../../core/net/psock.c:320: psock->readlen = 0;
	mov	a,#0x0F
	add	a,r2
	mov	r5,a
	clr	a
	...
	clr	a
	lcall	__gptrput
;	../../../core/net/psock.c:321: psock->bufptr = buffer;
	mov	a,#0x0A
	add	a,r2
	mov	r5,a
	clr	a
	...
	mov	a,@r0
	lcall	__gptrput
;	../../../core/net/psock.c:322: psock->bufsize = buffersize;
	mov	a,#0x16
	add	a,r2
	mov	r5,a
	clr	a
	...
	mov	a,@r0
	lcall	__gptrput
;	../../../core/net/psock.c:323: buf_setup(&psock->buf, buffer, buffersize);
	mov	a,#0x11
	add	a,r2
	mov	r5,a
	clr	a
	...
	pop	ar3
	pop	ar2
;	../../../core/net/psock.c:324: PT_INIT(&psock->pt);
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	clr	a
	...
	clr	a
	lcall	__gptrput
;	../../../core/net/psock.c:325: PT_INIT(&psock->psockpt);
	mov	a,#0x02
	add	a,r2
	mov	r2,a
	clr	a
