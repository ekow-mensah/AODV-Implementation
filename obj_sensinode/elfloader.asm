...
; This file was generated Sat Jan 27 13:26:17 2018
;--------------------------------------------------------
	.module elfloader
...
;------------------------------------------------------------
;offset                    Allocated to stack - offset -4
;buf                       Allocated to stack - offset -7
;len                       Allocated to stack - offset -9
;fd                        Allocated to registers r2 r3 
;------------------------------------------------------------
...
;------------------------------------------------------------
;symbol                    Allocated to stack - offset -5
;symtab                    Allocated to stack - offset -7
;symtabsize                Allocated to stack - offset -9
;strtab                    Allocated to stack - offset -11
;fd                        Allocated to stack - offset 1
;s                         Allocated to stack - offset 3
;a                         Allocated to registers r4 r5 
;name                      Allocated to stack - offset 19
;sect                      Allocated to registers r2 r3 r5 
;sloc0                     Allocated to stack - offset 49
;sloc1                     Allocated to stack - offset 51
;sloc2                     Allocated to stack - offset 55
;sloc3                     Allocated to stack - offset 56
;sloc4                     Allocated to stack - offset 59
;------------------------------------------------------------
...
;------------------------------------------------------------
;section                   Allocated to stack - offset -4
;size                      Allocated to stack - offset -6
;sectionaddr               Allocated to stack - offset -8
;sectionbase               Allocated to stack - offset -11
;strs                      Allocated to stack - offset -13
;strtab                    Allocated to stack - offset -15
;symtab                    Allocated to stack - offset -17
;symtabsize                Allocated to stack - offset -19
;using_relas               Allocated to stack - offset -20
;fd                        Allocated to stack - offset 1
;rela                      Allocated to stack - offset 3
;rel_size                  Allocated to stack - offset 15
;s                         Allocated to stack - offset 17
;a                         Allocated to stack - offset 33
;name                      Allocated to stack - offset 35
;addr                      Allocated to stack - offset 65
;sect                      Allocated to registers r5 r6 r7 
;sloc0                     Allocated to stack - offset 68
;sloc1                     Allocated to stack - offset 69
;sloc2                     Allocated to stack - offset 71
;sloc3                     Allocated to stack - offset 72
;sloc4                     Allocated to stack - offset 75
;sloc5                     Allocated to stack - offset 79
;sloc6                     Allocated to stack - offset 80
;------------------------------------------------------------
...
;------------------------------------------------------------
;symtab                    Allocated to stack - offset -4
;size                      Allocated to stack - offset -6
;strtab                    Allocated to stack - offset -8
;fd                        Allocated to stack - offset 1
;s                         Allocated to stack - offset 3
;a                         Allocated to registers r4 r5 
;name                      Allocated to stack - offset 19
...
;------------------------------------------------------------
;fd                        Allocated to stack - offset 1
;ehdr                      Allocated to stack - offset 3
;shdr                      Allocated to stack - offset 55
;strtable                  Allocated to stack - offset 95
;strs                      Allocated to stack - offset 135
;shdrptr                   Allocated to stack - offset 137
;nameptr                   Allocated to registers r5 r3 
;name                      Allocated to stack - offset 139
;i                         Allocated to stack - offset 151
;shdrnum                   Allocated to stack - offset 153
;shdrsize                  Allocated to stack - offset 155
;using_relas               Allocated to stack - offset 157
;textoff                   Allocated to stack - offset 158
;textsize                  Allocated to stack - offset 160
;textrelaoff               Allocated to registers r7 r4 
;textrelasize              Allocated to stack - offset 192
;dataoff                   Allocated to stack - offset 162
;datasize                  Allocated to stack - offset 190
;datarelaoff               Allocated to stack - offset 172
;datarelasize              Allocated to stack - offset 188
;rodataoff                 Allocated to stack - offset 164
;rodatasize                Allocated to stack - offset 186
;rodatarelaoff             Allocated to stack - offset 174
;rodatarelasize            Allocated to stack - offset 178
;symtaboff                 Allocated to stack - offset 166
;symtabsize                Allocated to stack - offset 168
;strtaboff                 Allocated to stack - offset 170
;strtabsize                Allocated to stack - offset 182
;bsssize                   Allocated to stack - offset 176
;process                   Allocated to registers r2 r3 r4 
;ret                       Allocated to registers r2 r3 
;sloc0                     Allocated to stack - offset 172
;sloc1                     Allocated to stack - offset 174
;sloc2                     Allocated to stack - offset 176
;sloc3                     Allocated to stack - offset 178
;sloc4                     Allocated to stack - offset 181
;sloc5                     Allocated to stack - offset 182
;sloc6                     Allocated to stack - offset 186
;sloc7                     Allocated to stack - offset 188
;sloc8                     Allocated to stack - offset 190
;sloc9                     Allocated to stack - offset 192
;sloc10                    Allocated to stack - offset 194
;sloc11                    Allocated to stack - offset 195
;sloc12                    Allocated to stack - offset 196
;sloc13                    Allocated to stack - offset 197
;sloc14                    Allocated to stack - offset 198
;sloc15                    Allocated to stack - offset 199
;sloc16                    Allocated to stack - offset 200
;sloc17                    Allocated to stack - offset 201
;sloc18                    Allocated to stack - offset 202
;sloc19                    Allocated to stack - offset 203
;sloc20                    Allocated to stack - offset 204
;sloc21                    Allocated to stack - offset 205
;sloc22                    Allocated to stack - offset 206
;sloc23                    Allocated to stack - offset 207
;sloc24                    Allocated to stack - offset 208
;sloc25                    Allocated to stack - offset 209
;sloc26                    Allocated to stack - offset 210
;sloc27                    Allocated to stack - offset 211
;sloc28                    Allocated to stack - offset 212
;sloc29                    Allocated to stack - offset 213
;sloc30                    Allocated to stack - offset 214
;sloc31                    Allocated to stack - offset 215
;sloc32                    Allocated to stack - offset 216
;sloc33                    Allocated to stack - offset 217
;sloc34                    Allocated to stack - offset 218
;sloc35                    Allocated to stack - offset 219
;sloc36                    Allocated to stack - offset 220
;sloc37                    Allocated to stack - offset 221
;sloc38                    Allocated to stack - offset 222
;sloc39                    Allocated to stack - offset 223
;sloc40                    Allocated to stack - offset 251
;sloc41                    Allocated to stack - offset 224
;sloc42                    Allocated to stack - offset 228
;------------------------------------------------------------
