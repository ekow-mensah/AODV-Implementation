...
; This file was generated Sat Jan 27 13:26:18 2018
;--------------------------------------------------------
	.module profile
...
;episode_end_time          Allocated to registers r2 r3 
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated to stack - offset 1
;last                      Allocated to stack - offset 3
;t                         Allocated to stack - offset 5
;a                         Allocated to registers 
;timetable                 Allocated to registers 
;entry                     Allocated to stack - offset 7
