...
; This file was generated Sat Jan 27 13:27:26 2018
;--------------------------------------------------------
	.module dhcpc
...
;optptr                    Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:97: add_msg_type(u8_t *optptr, u8_t type)
;	-----------------------------------------
...
;optptr                    Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:106: add_server_id(u8_t *optptr)
;	-----------------------------------------
...
;optptr                    Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:115: add_req_ipaddr(u8_t *optptr)
;	-----------------------------------------
...
;optptr                    Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:124: add_req_options(u8_t *optptr)
;	-----------------------------------------
...
;optptr                    Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:135: add_end(u8_t *optptr)
;	-----------------------------------------
;	 function add_end
;	-----------------------------------------
_add_end:
...
;sloc2                     Allocated to stack - offset 4
;------------------------------------------------------------
...
;	../../../core/net/dhcpc.c:149: m->secs = 0;
	...
	clr	a
	lcall	__gptrput
;	../../../core/net/dhcpc.c:150: m->flags = HTONS(BOOTP_BROADCAST); /*  Broadcast bit. */
	mov	r0,_bp
	inc	r0
	mov	a,#0x0A
	add	a,@r0
...
;------------------------------------------------------------
;end                       Allocated to registers r2 r3 r4 
...
;	../../../core/net/dhcpc.c:176: end = add_end(end);
	...
	mov	r2,dpl
	mov	r3,dph
;	../../../core/net/dhcpc.c:178: uip_send(uip_appdata, (int)(end - (u8_t *)uip_appdata));
	mov	dptr,#_uip_appdata
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;	../../../core/net/dhcpc.c:192: end = add_end(end);
	...
	mov	r2,dpl
	mov	r3,dph
;	../../../core/net/dhcpc.c:194: uip_send(uip_appdata, (int)(end - (u8_t *)uip_appdata));
	mov	dptr,#_uip_appdata
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;optptr                    Allocated to stack - offset 1
;end                       Allocated to stack - offset 4
;type                      Allocated to registers r5 
;------------------------------------------------------------
;	../../../core/net/dhcpc.c:198: parse_options(u8_t *optptr, int len)
;	-----------------------------------------
...
_parse_options:
	...
	inc	sp
	inc	sp
;	../../../core/net/dhcpc.c:200: u8_t *end = optptr + len;
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0xfc
	...
	inc	r0
	mov	@r0,ar7
;	../../../core/net/dhcpc.c:201: u8_t type = 0;
	mov	r5,#0x00
...
;------------------------------------------------------------
;m                         Allocated to stack - offset 1
;optptr                    Allocated to stack - offset 4
;end                       Allocated to registers r2 r3 r4 
...
;	../../../core/net/dhcpc.c:252: struct dhcp_msg *m = (struct dhcp_msg *)uip_appdata;
	...
	inc	r0
	mov	@r0,ar7
;	../../../core/net/dhcpc.c:253: u8_t *optptr = &m->options[4];
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0x04
	...
	mov	a,@r0
	mov	@r1,a
;	../../../core/net/dhcpc.c:254: u8_t *end = (u8_t*)uip_appdata + uip_datalen();
	mov	dptr,#_uip_len
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
;PT_YIELD_FLAG             Allocated to registers r3 
;ticks                     Allocated to registers r3 r7 
;ticks                     Allocated to registers r3 r7 
...
_handle_dhcp:
	...
	mov	sp,a
	mov	r2,dpl
;	../../../core/net/dhcpc.c:274: PT_BEGIN(&s.pt);
	mov	r3,#0x01
	mov	dptr,#_s
	movx	a,@dptr
	mov	r4,a
...
00260$:
	ljmp	00201$
;	../../../core/net/dhcpc.c:276: init:
00102$:
;	../../../core/net/dhcpc.c:277: xid++;
	mov	dptr,#_xid
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
	...
	addc	a,#0x00
	movx	@dptr,a
;	../../../core/net/dhcpc.c:278: s.state = STATE_SENDING;
	mov	dptr,#(_s + 0x0002)
	mov	a,#0x01
	movx	@dptr,a
;	../../../core/net/dhcpc.c:279: s.ticks = CLOCK_SECOND;
	mov	dptr,#(_s + 0x0010)
	mov	a,#0x80
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/dhcpc.c:281: while(ev != tcpip_event) {
00109$:
	...
	sjmp	00111$
00261$:
;	../../../core/net/dhcpc.c:282: tcpip_poll_udp(s.conn);
	mov	dptr,#(_s + 0x0003)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	pop	ar2
;	../../../core/net/dhcpc.c:283: PT_YIELD(&s.pt);
	mov	r3,#0x00
	mov	dptr,#_s
	mov	a,#0x1B
	movx	@dptr,a
...
00103$:
	...
	ljmp	00202$
00111$:
;	../../../core/net/dhcpc.c:285: send_discover();
	push	ar2
	lcall	_send_discover
;	../../../core/net/dhcpc.c:286: etimer_set(&s.etimer, s.ticks);
	mov	dptr,#(_s + 0x0010)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	dec	sp
	pop	ar2
;	../../../core/net/dhcpc.c:288: PT_YIELD(&s.pt);
00115$:
	mov	r3,#0x00
	mov	dptr,#_s
	mov	a,#0x20
...
00112$:
	...
	ljmp	00202$
00116$:
;	../../../core/net/dhcpc.c:289: if(ev == tcpip_event && uip_newdata() && msg_for_me() == DHCPOFFER) {
	mov	dptr,#_tcpip_event
	movx	a,@dptr
	mov	r4,a
	mov	a,r2
	...
	cjne	r4,#0x02,00123$
	cjne	r5,#0x00,00123$
;	../../../core/net/dhcpc.c:290: parse_msg();
	push	ar2
	lcall	_parse_msg
	pop	ar2
;	../../../core/net/dhcpc.c:291: s.state = STATE_OFFER_RECEIVED;
	mov	dptr,#(_s + 0x0002)
	mov	a,#0x02
	movx	@dptr,a
;	../../../core/net/dhcpc.c:292: goto selecting;
	sjmp	00130$
00123$:
;	../../../core/net/dhcpc.c:294: } while (!etimer_expired(&s.etimer));
	mov	dptr,#(_s + 0x0006)
	mov	b,#0x00
	push	ar2
	...
	orl	a,b
	jz	00115$
;	../../../core/net/dhcpc.c:296: if(s.ticks < CLOCK_SECOND * 60) {
	mov	dptr,#(_s + 0x0010)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	ljmp	00109$
00270$:
;	../../../core/net/dhcpc.c:297: s.ticks *= 2;
	mov	a,r4
	add	a,r4
	mov	r4,a
	mov	a,r5
	...
	movx	@dptr,a
	ljmp	00109$
;	../../../core/net/dhcpc.c:301: selecting:
00130$:
;	../../../core/net/dhcpc.c:302: xid++;
	mov	dptr,#_xid
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
	...
	addc	a,#0x00
	movx	@dptr,a
;	../../../core/net/dhcpc.c:303: s.ticks = CLOCK_SECOND;
	mov	dptr,#(_s + 0x0010)
	mov	a,#0x80
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/dhcpc.c:305: while(ev != tcpip_event) {
00137$:
	mov	dptr,#_tcpip_event
	movx	a,@dptr
	mov	r4,a
	...
	sjmp	00139$
00271$:
;	../../../core/net/dhcpc.c:306: tcpip_poll_udp(s.conn);
	mov	dptr,#(_s + 0x0003)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	lcall	_tcpip_poll_udp
	pop	ar2
;	../../../core/net/dhcpc.c:307: PT_YIELD(&s.pt);
	mov	r3,#0x00
	mov	dptr,#_s
	mov	a,#0x33
	movx	@dptr,a
...
00131$:
	...
	ljmp	00202$
00139$:
;	../../../core/net/dhcpc.c:309: send_request();
	push	ar2
	lcall	_send_request
;	../../../core/net/dhcpc.c:310: etimer_set(&s.etimer, s.ticks);
	mov	dptr,#(_s + 0x0010)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	dec	sp
	pop	ar2
;	../../../core/net/dhcpc.c:312: PT_YIELD(&s.pt);
00143$:
	mov	r3,#0x00
	mov	dptr,#_s
	mov	a,#0x38
...
00140$:
	...
	ljmp	00202$
00144$:
;	../../../core/net/dhcpc.c:313: if(ev == tcpip_event && uip_newdata() && msg_for_me() == DHCPACK) {
	mov	dptr,#_tcpip_event
	movx	a,@dptr
	mov	r4,a
	mov	a,r2
	...
	cjne	r4,#0x05,00151$
	cjne	r5,#0x00,00151$
;	../../../core/net/dhcpc.c:314: parse_msg();
	push	ar2
	lcall	_parse_msg
	pop	ar2
;	../../../core/net/dhcpc.c:315: s.state = STATE_CONFIG_RECEIVED;
	mov	dptr,#(_s + 0x0002)
	mov	a,#0x03
	movx	@dptr,a
;	../../../core/net/dhcpc.c:316: goto bound;
	sjmp	00159$
00151$:
;	../../../core/net/dhcpc.c:318: } while (!etimer_expired(&s.etimer));
	mov	dptr,#(_s + 0x0006)
	mov	b,#0x00
	push	ar2
	lcall	_etimer_expired
	...
	orl	a,b
	jz	00143$
;	../../../core/net/dhcpc.c:320: if(s.ticks <= CLOCK_SECOND * 10) {
	mov	dptr,#(_s + 0x0010)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	ljmp	00102$
00280$:
;	../../../core/net/dhcpc.c:321: s.ticks += CLOCK_SECOND;
	mov	a,#0x80
	add	a,r4
	mov	r4,a
	clr	a
	...
	mov	a,r7
	movx	@dptr,a
;	../../../core/net/dhcpc.c:325: } while(s.state != STATE_CONFIG_RECEIVED);
	mov	dptr,#(_s + 0x0002)
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x03,00281$
...
00281$:
	ljmp	00137$
00282$:
;	../../../core/net/dhcpc.c:327: bound:
00159$:
;	../../../core/net/dhcpc.c:338: dhcpc_configured(&s);
	push	ar2
	mov	dptr,#_s
	mov	b,#0x00
	push	ar2
	lcall	_dhcpc_configured
;	../../../core/net/dhcpc.c:346: s.ticks = (ntohs(s.lease_time[0])*65536ul + ntohs(s.lease_time[1])
	mov	dptr,#(_s + 0x001d)
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	../../../core/net/dhcpc.c:395: PT_END(&s.pt);
	pop	ar2
;	../../../core/net/dhcpc.c:352: while(s.ticks > 0) {
00170$:
	mov	dptr,#(_s + 0x0010)
	movx	a,@dptr
	mov	r4,a
	...
	ljmp	00173$
00283$:
;	../../../core/net/dhcpc.c:354: ticks = IMIN(s.ticks, MAX_TICKS);
	clr	c
	mov	a,r4
	subb	a,#0xFF
	mov	a,r5
...
00205$:
	...
	mov	ar3,r4
	mov	ar7,r5
;	../../../core/net/dhcpc.c:355: s.ticks -= ticks;
	mov	dptr,#(_s + 0x0010)
	mov	r0,_bp
	inc	r0
	movx	a,@dptr
	...
	mov	a,r6
	movx	@dptr,a
;	../../../core/net/dhcpc.c:356: etimer_set(&s.etimer, ticks);
	push	ar2
	push	ar3
	push	ar7
	mov	dptr,#(_s + 0x0006)
	...
	dec	sp
	pop	ar2
;	../../../core/net/dhcpc.c:357: PT_YIELD_UNTIL(&s.pt, etimer_expired(&s.etimer));
	mov	r3,#0x00
	mov	dptr,#_s
	mov	a,#0x65
	movx	@dptr,a
...
00164$:
	mov	dpl,#0x01
	ljmp	00202$
;	../../../core/net/dhcpc.c:361: <= MAX_TICKS32) {
00173$:
;	../../../core/net/dhcpc.c:362: s.ticks = (ntohs(s.lease_time[0])*65536ul + ntohs(s.lease_time[1])
	push	ar2
	mov	dptr,#(_s + 0x001d)
	movx	a,@dptr
	mov	r4,a
...
;------------------------------------------------------------
;mac_len                   Allocated to stack - offset -4
;mac_addr                  Allocated to registers r2 r3 r4 
...
;	../../../core/net/dhcpc.c:407: uip_ipaddr(&addr, 255,255,255,255);
	...
	mov	r0,a
	mov	@r0,#0xFF
;	../../../core/net/dhcpc.c:408: s.conn = udp_new(&addr, HTONS(DHCPC_SERVER_PORT), NULL);
	mov	r2,_bp
	inc	r2
	mov	r3,#0x00
	mov	r4,#0x40
...
;	../../../core/net/dhcpc.c:409: if(s.conn != NULL) {
	...
	sjmp	00105$
00109$:
;	../../../core/net/dhcpc.c:410: udp_bind(s.conn, HTONS(DHCPC_CLIENT_PORT));
	mov	a,#0x04
	add	a,r2
	mov	r2,a
	clr	a
