...
; This file was generated Sat Jan 27 13:26:20 2018
;--------------------------------------------------------
	.module timetable
...
;------------------------------------------------------------
;dummy1                    Allocated to stack - offset 1
;dummy2                    Allocated to stack - offset 2
...
;------------------------------------------------------------
;id1                       Allocated to stack - offset -5
;id2                       Allocated to stack - offset -8
;t                         Allocated to stack - offset 1
;i                         Allocated to registers r4 
;t1                        Allocated to stack - offset 4
;t2                        Allocated to stack - offset 6
...
;time                      Allocated to stack - offset 9
