...
; This file was generated Sat Jan 27 13:26:24 2018
;--------------------------------------------------------
	.module compower
...
;listen                    Allocated to stack - offset 4
;transmit                  Allocated to stack - offset 8
...
_compower_accumulate:
	...
	add	a,#0x13
	mov	sp,a
;	../../../core/sys/compower.c:66: listen = energest_type_time(ENERGEST_TYPE_LISTEN);
	mov	dptr,#0x0007
	...
	inc	r0
	mov	@r0,ar5
;	../../../core/sys/compower.c:67: e->listen += listen - last_listen;
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
	...
	mov	a,r5
	lcall	__gptrput
;	../../../core/sys/compower.c:68: last_listen = listen;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	dptr,#_compower_accumulate_last_listen_1_1
	...
	mov	a,@r0
	movx	@dptr,a
;	../../../core/sys/compower.c:70: transmit = energest_type_time(ENERGEST_TYPE_TRANSMIT);
	mov	dptr,#0x0006
	lcall	_energest_type_time
	mov	r2,dpl
	mov	r3,dph
	...
	inc	r0
	mov	@r0,ar5
;	../../../core/sys/compower.c:71: e->transmit += transmit - last_transmit;
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0x0c
	...
	mov	a,r3
	lcall	__gptrput
;	../../../core/sys/compower.c:72: last_transmit = transmit;
	mov	a,_bp
	add	a,#0x08
	mov	r0,a
	mov	dptr,#_compower_accumulate_last_transmit_1_1
...
;------------------------------------------------------------
;	../../../core/sys/compower.c:76: compower_clear(struct compower_activity *e)
;	-----------------------------------------
...
_compower_clear:
	...
	mov	r3,dph
	mov	r4,b
;	../../../core/sys/compower.c:78: e->listen = e->transmit = 0;
	mov	a,#0x04
	add	a,r2
	mov	r5,a
	clr	a
...
;------------------------------------------------------------
;	../../../core/sys/compower.c:82: compower_attrconv(struct compower_activity *e)
;	-----------------------------------------
...
_compower_attrconv:
	...
	add	a,#0x0b
	mov	sp,a
;	../../../core/sys/compower.c:85: packetbuf_attr(PACKETBUF_ATTR_LISTEN_TIME) + e->listen);
	mov	dpl,#0x07
	...
	mov	a,@r0
	addc	a,r4
;	../../../core/sys/compower.c:84: packetbuf_set_attr(PACKETBUF_ATTR_LISTEN_TIME,
	push	ar5
	push	ar6
	mov	dpl,#0x07
	...
	dec	sp
	dec	sp
;	../../../core/sys/compower.c:87: packetbuf_attr(PACKETBUF_ATTR_TRANSMIT_TIME) + e->transmit);
	mov	dpl,#0x08
	lcall	_packetbuf_attr
	mov	r2,dpl
	mov	r3,dph
	...
	mov	a,@r0
	addc	a,r6
;	../../../core/sys/compower.c:86: packetbuf_set_attr(PACKETBUF_ATTR_TRANSMIT_TIME,
	push	ar4
	push	ar3
	mov	dpl,#0x08
	lcall	_packetbuf_set_attr
...
;------------------------------------------------------------
;	../../../core/sys/compower.c:91: compower_accumulate_attrs(struct compower_activity *e)
;	-----------------------------------------
...
_compower_accumulate_attrs:
	...
	add	a,#0x0b
	mov	sp,a
;	../../../core/sys/compower.c:93: e->listen += packetbuf_attr(PACKETBUF_ATTR_LISTEN_TIME);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
	...
	mov	a,r6
	lcall	__gptrput
;	../../../core/sys/compower.c:94: e->transmit += packetbuf_attr(PACKETBUF_ATTR_TRANSMIT_TIME);
	mov	r0,_bp
	inc	r0
	mov	a,_bp
	add	a,#0x04
