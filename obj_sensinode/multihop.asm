...
; This file was generated Sat Jan 27 13:25:11 2018
;--------------------------------------------------------
	.module multihop
...
;uc                        Allocated to stack - offset 1
;c                         Allocated to stack - offset 4
;nexthop                   Allocated to registers r2 r3 r4 
;sender                    Allocated to stack - offset 7
;receiver                  Allocated to stack - offset 9
...
;	../../../core/net/rime/multihop.c:96: if(c->cb->forward) {
	...
	ljmp	00104$
00119$:
;	../../../core/net/rime/multihop.c:98: from, packetbuf_attr(PACKETBUF_ATTR_HOPS));
	mov	dpl,#0x13
	lcall	_packetbuf_attr
	mov	r7,dpl
	mov	ar2,r7
;	../../../core/net/rime/multihop.c:97: nexthop = c->cb->forward(c, &sender, &receiver,
	mov	a,_bp
	add	a,#0x09
	mov	r5,a
	mov	a,_bp
...
00120$:
	...
	mov	ar3,r6
	mov	ar4,r7
;	../../../core/net/rime/multihop.c:101: packetbuf_attr(PACKETBUF_ATTR_HOPS) + 1);
	mov	dpl,#0x13
	push	ar2
	push	ar3
	push	ar4
	...
	addc	a,b
	mov	r6,a
;	../../../core/net/rime/multihop.c:100: packetbuf_set_attr(PACKETBUF_ATTR_HOPS,
	push	ar5
	push	ar6
	mov	dpl,#0x13
	...
	pop	ar2
00104$:
;	../../../core/net/rime/multihop.c:103: if(nexthop) {
	mov	a,r2
	orl	a,r3
	orl	a,r4
	jz	00110$
;	../../../core/net/rime/multihop.c:105: unicast_send(&c->c, nexthop);
	push	ar2
	push	ar3
	push	ar4
	mov	a,_bp
...
;------------------------------------------------------------
;	../../../core/net/rime/multihop.c:113: multihop_open(struct multihop_conn *c, uint16_t channel,
;	-----------------------------------------
...
_multihop_open:
	...
	mov	r3,dph
	mov	r4,b
;	../../../core/net/rime/multihop.c:116: unicast_open(&c->c, channel, &data_callbacks);
	push	ar2
	push	ar3
	push	ar4
	...
	add	a,#0xfb
	mov	sp,a
;	../../../core/net/rime/multihop.c:117: channel_set_attributes(channel, attributes);
	mov	a,#_attributes
	push	acc
	mov	a,#(_attributes >> 8)
	push	acc
	...
	pop	ar3
	pop	ar2
;	../../../core/net/rime/multihop.c:118: c->cb = callbacks;
	mov	a,#0x12
	add	a,r2
	mov	r2,a
	clr	a
...
;c                         Allocated to registers r2 r3 r4 
;------------------------------------------------------------
;	../../../core/net/rime/multihop.c:122: multihop_close(struct multihop_conn *c)
;	-----------------------------------------
;	 function multihop_close
;	-----------------------------------------
_multihop_close:
;	../../../core/net/rime/multihop.c:124: unicast_close(&c->c);
	ljmp	_unicast_close
;------------------------------------------------------------
...
;nexthop                   Allocated to registers r4 r3 r2 
;------------------------------------------------------------
;	../../../core/net/rime/multihop.c:128: multihop_send(struct multihop_conn *c, const rimeaddr_t *to)
;	-----------------------------------------
...
_multihop_send:
	...
	push	dph
	push	b
;	../../../core/net/rime/multihop.c:132: if(c->cb->forward == NULL) {
	mov	r0,_bp
	inc	r0
	mov	a,#0x12
	add	a,@r0
	...
	orl	a,r2
	jnz	00102$
;	../../../core/net/rime/multihop.c:133: return 0;
	mov	dptr,#0x0000
	ljmp	00106$
00102$:
;	../../../core/net/rime/multihop.c:135: packetbuf_compact();
	push	ar5
	push	ar6
	push	ar7
	...
	pop	ar6
	pop	ar5
;	../../../core/net/rime/multihop.c:136: nexthop = c->cb->forward(c, &rimeaddr_node_addr, to, NULL, 0);
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
...
00111$:
	...
	mov	ar4,r5
	mov	ar3,r6
;	../../../core/net/rime/multihop.c:138: if(nexthop == NULL) {
	mov	a,r4
	orl	a,r3
	orl	a,r2
	jnz	00104$
;	../../../core/net/rime/multihop.c:140: return 0;
	mov	dptr,#0x0000
	sjmp	00106$
00104$:
;	../../../core/net/rime/multihop.c:144: packetbuf_set_addr(PACKETBUF_ADDR_ERECEIVER, to);
	push	ar2
	push	ar3
	push	ar4
	mov	a,_bp
	...
	dec	sp
	dec	sp
;	../../../core/net/rime/multihop.c:145: packetbuf_set_addr(PACKETBUF_ADDR_ESENDER, &rimeaddr_node_addr);
	mov	a,#_rimeaddr_node_addr
	push	acc
	mov	a,#(_rimeaddr_node_addr >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	../../../core/net/rime/multihop.c:146: packetbuf_set_attr(PACKETBUF_ATTR_HOPS, 1);
	mov	a,#0x01
	push	acc
	clr	a
	push	acc
	...
	pop	ar3
	pop	ar2
;	../../../core/net/rime/multihop.c:147: unicast_send(&c->c, nexthop);
	push	ar4
	push	ar3
	push	ar2
	mov	r0,_bp
	...
	dec	sp
	dec	sp
;	../../../core/net/rime/multihop.c:148: return 1;
	mov	dptr,#0x0001
00106$:
	mov	sp,_bp
	pop	_bp
