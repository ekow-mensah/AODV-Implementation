...
; This file was generated Sat Jan 27 13:27:13 2018
;--------------------------------------------------------
	.module uip_fw
...
;------------------------------------------------------------
;netipaddr                 Allocated to stack - offset -5
;netmask                   Allocated to stack - offset -8
...
;	../../../core/net/uip-fw.c:244: ICMPBUF->icmpchksum = 0;
	...
	inc	dptr
	movx	@dptr,a
;	../../../core/net/uip-fw.c:245: ICMPBUF->icmpchksum = ~uip_chksum((u16_t *)&(ICMPBUF->type), 36);
	mov	a,#0x24
	push	acc
	clr	a
	push	acc
...
;	../../../core/net/uip-fw.c:257: ICMPBUF->len[0] = 0;
	...
	movx	@dptr,a
;	../../../core/net/uip-fw.c:258: ICMPBUF->len[1] = (u8_t)uip_len;
...
;------------------------------------------------------------
;fw                        Allocated to stack - offset 1
;i                         Allocated to registers r7 r4 
;oldest                    Allocated to registers r2 r3 
;sloc0                     Allocated to stack - offset 4
;sloc1                     Allocated to stack - offset 6
;------------------------------------------------------------
...
;------------------------------------------------------------
;netif                     Allocated to stack - offset 1
;------------------------------------------------------------
...
;------------------------------------------------------------
;netif                     Allocated to registers r2 r3 r4 
;------------------------------------------------------------
...
00122$:
	clr	c
	mov	a,r4
	subb	a,#(_fwcache + 0x001c)
	mov	a,r5
	subb	a,#((_fwcache + 0x001c) >> 8)
	mov	a,r6
	subb	a,#0x00
	jc	00148$
	ljmp	00125$
...
;	../../../core/net/uip-fw.c:466: BUF->ttl = BUF->ttl - 1;
	...
	mov	a,r2
	movx	@dptr,a
;	../../../core/net/uip-fw.c:469: if(BUF->ipchksum >= HTONS(0xffff - 0x0100)) {
	mov	dptr,#(_uip_aligned_buf + 0x0018)
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,#0xFF
	jc	00118$
;	../../../core/net/uip-fw.c:470: BUF->ipchksum = BUF->ipchksum + HTONS(0x0100) + 1;
	mov	a,#0x02
	add	a,r2
	mov	r4,a
	clr	a
	...
	sjmp	00119$
00118$:
;	../../../core/net/uip-fw.c:472: BUF->ipchksum = BUF->ipchksum + HTONS(0x0100);
	inc	r2
	cjne	r2,#0x00,00169$
	inc	r3
00169$:
